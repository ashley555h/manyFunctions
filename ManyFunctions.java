...
public class ManyFunctions
{
     ...
     */
    public static int maximum(int c, int d)
    {
        // TODO
        if (c < d) {
            return d;
     ...
     */
    public static boolean isOddNumber(int e)
    {
        // TODO
        if (e % 2 > 0) {
            return true;
     ...
     */
    public static boolean isEvenNumber(int f)
    {
        // TODO
        if (f % 2 <= 0) {
            return true;
     ...
     */
    public static boolean isVowel(String letterIsVowel)
    {
        // TODO
        if (letterIsVowel.equals("a") || letterIsVowel.equals("e") || letterIsVowel.equals("i") || letterIsVowel.equals("i") || letterIsVowel.equals("o") || letterIsVowel.equals("u") || letterIsVowel.matches("A") || letterIsVowel.matches ("E") || letterIsVowel.matches ("I") || letterIsVowel.matches ("O") || letterIsVowel.matches ("U")) {
            return true;
        } else
        return false;
    }
     ...
     */
    public static boolean isConsonant(String letterIsConsonant)
    {
        // TODO
        if (letterIsConsonant.equals("a") || letterIsConsonant.equals("e") || letterIsConsonant.equals("i") || letterIsConsonant.equals("i") || letterIsConsonant.equals("o") || letterIsConsonant.equals("u") || letterIsConsonant.matches("A") || letterIsConsonant.matches ("E") || letterIsConsonant.matches ("I") || letterIsConsonant.matches("O") || letterIsConsonant.matches ("U")) {
            return false;
        } else
        return true;
    }
